...
<div class="todo-app-container">
    ...
    <div class="glass-card status-summary-card">
        ...
        <div class="stats-container">
            <div class="stat-box">
                <span class="stat-number">{{ count($todos) }}</span>
        ...
        <form action="/todos" method="POST" class="todo-form">
            <div class="form-grid">
                <div class="form-group title-group">
                    ...
                    <input type="text" id="title" name="title" placeholder="e.g. Implement database migrations" value="{{ $old['title'] ?? '' }}" required autocomplete="off">
                </div>
                <div class="form-group desc-group">
                    <label for="description">Additional Details (Optional)</label>
                    <input type="text" id="description" name="description" placeholder="e.g. Set up SQLite schema and test connectivity" value="{{ $old['description'] ?? '' }}" autocomplete="off">
                </div>
    ...
    <div class="todo-list-section">
        ...
        <div class="tasks-grid">
            ...
            <div class="glass-card task-card @if($todo->completed) completed-task @endif">
                <div class="task-header">
                    ...
                    <div class="task-details">
                        ...
                        @endif
                        <span class="task-time">Created {{ date('M d, H:i', strtotime($todo->created_at)) }}</span>
                    </div>
                </div>

                <div class="task-actions">
                    <a href="/todos/{{ $todo->id }}/edit" class="action-btn edit-btn" title="Edit Task">
                        <span>✏️</span> Edit
                    </a>
                    <form action="/todos/{{ $todo->id }}/delete" method="POST" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this task?');">
